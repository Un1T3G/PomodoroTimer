...
import 'package:pomodoro_timer_task_management/views/screens/settings/theme_picker_page.dart';
import 'package:pomodoro_timer_task_management/views/screens/settings/timer_theme_picker_page.dart';
...
abstract class SettingsNavigationRoutes {
  ...
  static const String timerThemePicker = 'timer_theme_picker';
...
abstract class SettingsNavigation {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case SettingsNavigationRoutes.themePicker:
        return CupertinoPageRoute(
          builder: (_) => const ThemePickerPage(),
        );
      case SettingsNavigationRoutes.timerThemePicker:
        return CupertinoPageRoute(
          builder: (_) => const TimerThemePickerPage(),
        );
      default:
        return CupertinoPageRoute(
          builder: (_) => Center(
